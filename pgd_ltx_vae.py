...
def main():
    ...
    parser = argparse.ArgumentParser(description="PGD attack on LTX Video VAE")
    parser.add_argument("--input_dir", type=str, default="resources/test-images")
    parser.add_argument("--output_dir", type=str, default="results/ltx_pgd")
    ...
    # Load LTX Video VAE (128 latent channels, 3D video VAE)
    print(f"Loading LTX Video VAE from {args.model_id} ...")
    vae = AutoencoderKLLTXVideo.from_pretrained(args.model_id, subfolder="vae")
